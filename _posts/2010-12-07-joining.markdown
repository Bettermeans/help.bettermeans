...
If you don't understand what a workstream is, click here.

Some useful tools will be:

* The Activity stream to see what has been happening most recently.
* The Dashboard to get an overview of the work being done. From here you can also offer new ideas, comment, vote, prioritize and more. 
...
You can see an overview of your team (in the Overview or Team tabs) and also invite others to join your work.

Once you start working, your homepage will become populated with the items that you own, the workstreams you are involved in, and the activity relevant to your work.

Also remember, that you can also always start your own workstream for your own project.
